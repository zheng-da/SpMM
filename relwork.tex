...
Williams et al.~\cite{Williams07}
...
a single machine
and scales to large graphs with disks. It performs 2D partitioning on a graph
...
factorization (NMF) with MapReduce. Although these MapReduced-based
implementations can scale to very large graphs, they typically run orders of
magnitude more slowly than optimized solutions due to the overhead from
MapReduce.
...
in the distributed environment. In contrast, our SEM-SpMM handles dense matrices
of different sizes and our eigensolver stores both
