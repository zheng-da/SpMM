...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State $read(STR, callback=ProcessSTRow)$
...
approaches completion. The global task queue maintains a global execution
...
To better utilize the CPU cache, we process tiles of a partition in
