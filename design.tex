...
gets close to the end. The other benefit of maintaining a global
...
Due to the sparsity of real-world graphs,
...
recommender systems. NMF can also be applied to graphs, for example, to find communities
\cite{yang13, wang11}.
