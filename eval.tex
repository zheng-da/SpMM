...
our IM-SpMM can run on all of the graphs in a single instance of the same
type. Even though an EC2 instance has only 16 physical CPU cores, one third of
the CPU cores on our NUMA machine, our IM-SpMM on an EC2 instance achieves around
...
increases I/O throughput and, thus, improves performance. In contrast,
SEM-SpMV with SCSR on the Friendster graph already achieves almost 80\% of
