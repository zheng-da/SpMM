...
of the SSD array, which suggests
...
caused by SEM-SpMM drops and becomes only a small fraction of the bandwidth of
SSDs. As such, CPU becomes the bottleneck of the system.
