...
$d=0.05$.}. We always use the undirected version for performance evaluation of
sparse matrix multiplication. The Page graph is clustered
...
matrices involved in SpMM have a small number of columns. We use Intel MKL 2015
and Trilinos v12.0.1 for the experiments.
...
be almost twice as fast as MKL when the dense matrix has eight columns.
