...
%% Sat 23 Jan 2016 09:29:04 PM EST
...
\def\gpfillpath{(2.257,0.627)--(2.524,0.627)--(2.524,1.821)--(2.257,1.821)--cycle}
\gpfill{color=gpbgfillcolor} \gpfillpath;
\gpfill{color=gp lt color 0,gp pattern 0,pattern color=.} \gpfillpath;
\draw[gp path] (2.257,0.627)--(2.257,1.820)--(2.523,1.820)--(2.523,0.627)--cycle;
\def\gpfillpath{(3.584,0.627)--(3.850,0.627)--(3.850,2.458)--(3.584,2.458)--cycle}
\gpfill{color=gpbgfillcolor} \gpfillpath;
\gpfill{color=gp lt color 0,gp pattern 0,pattern color=.} \gpfillpath;
\draw[gp path] (3.584,0.627)--(3.584,2.457)--(3.849,2.457)--(3.849,0.627)--cycle;
\def\gpfillpath{(4.910,0.627)--(5.177,0.627)--(5.177,2.829)--(4.910,2.829)--cycle}
\gpfill{color=gpbgfillcolor} \gpfillpath;
\gpfill{color=gp lt color 0,gp pattern 0,pattern color=.} \gpfillpath;
\draw[gp path] (4.910,0.627)--(4.910,2.828)--(5.176,2.828)--(5.176,0.627)--cycle;
\def\gpfillpath{(6.237,0.627)--(6.503,0.627)--(6.503,2.776)--(6.237,2.776)--cycle}
\gpfill{color=gpbgfillcolor} \gpfillpath;
\gpfill{color=gp lt color 0,gp pattern 0,pattern color=.} \gpfillpath;
\draw[gp path] (6.237,0.627)--(6.237,2.775)--(6.502,2.775)--(6.502,0.627)--cycle;
\gpcolor{color=gp lt color border}
...
\def\gpfillpath{(2.523,0.627)--(2.789,0.627)--(2.789,1.026)--(2.523,1.026)--cycle}
\gpfill{color=gpbgfillcolor} \gpfillpath;
\gpfill{color=gp lt color 1,gp pattern 1,pattern color=.} \gpfillpath;
\draw[gp path] (2.523,0.627)--(2.523,1.025)--(2.788,1.025)--(2.788,0.627)--cycle;
...
\def\gpfillpath{(2.788,0.627)--(3.054,0.627)--(3.054,1.079)--(2.788,1.079)--cycle}
\gpfill{color=gpbgfillcolor} \gpfillpath;
\gpfill{color=gp lt color 2,gp pattern 2,pattern color=.} \gpfillpath;
\draw[gp path] (2.788,0.627)--(2.788,1.078)--(3.053,1.078)--(3.053,0.627)--cycle;
