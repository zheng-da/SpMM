...
\begin{abstract}
Owing to random memory access patterns, sparse matrix multiplication,
especially on the sparse matrices encoding graphs, is traditionally performed
in memory and scales to large matrices using the distributed memory of
multiple nodes.
