...
CPU cache misses in sparse matrix multiplication because \hl{graphs are sparse and
enormous and a vertex in a graph can connect to arbitrary other vertices}.
