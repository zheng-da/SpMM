...
\title{Semi-External Memory Sparse Matrix Multiplication on Large
...
and the dense matrix in memory. As such, the SEM implementation can incorporate
...
Our experiments show that the SEM implementation achieves almost 100\% performance
of the in-memory implementation on some graphs when the dense matrix has more
than four columns; it achieves at least 60\% performance of the in-memory
