...
\title{Semi-External Memory Sparse Matrix Multiplication for Billion-node Graphs} %in a Multicore Architecture}
...
\maketitle
\begin{abstract}
%Owing to random memory access patterns, 
...
connection. Our SEM SpMM outperforms the in-memory implementations of Trilinos
