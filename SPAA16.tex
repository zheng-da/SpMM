...
\footnotesize Institute for Computational Medicine \\
\footnotesize Department of Biomedical Engineering \\
\footnotesize Johns Hopkins University
% copy the following lines to add more authors
\and
{\rm Alexander S. Szalay}\\
\footnotesize Department of Physics and Astronomy \\
\footnotesize Johns Hopkins University
} % end author
...
and dense matrices in memory. As such, our SEM SpMM can incorporate with many
